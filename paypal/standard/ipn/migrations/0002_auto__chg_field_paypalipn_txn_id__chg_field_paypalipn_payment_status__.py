...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('paypal_ipn', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=30))
        ...
        db.alter_column('paypal_ipn', 'auth_status', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PayPalIPN.auth_status'
        db.alter_column('paypal_ipn', 'auth_status', self.gf('models.CharField')(max_length=9))
    ...
    models = {
        'ipn.paypalipn': {
            ...
            'auth_status': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'payment_status': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
